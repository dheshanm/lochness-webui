...
export default function AddCantabDataSource({
    params,
}: {
    params: Params
}) {
        ...
        <>
            ...
            <div className="container mx-auto p-6 max-w-5xl flex flex-col h-full">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h1 className="text-2xl font-semibold">Add CANTAB Data Source</h1>
                </div>

                <div className="flex-grow overflow-auto mt-4">
                    {projectId && siteId && <CantabForm project_id={projectId} site_id={siteId} instance_name={null} />}
                </div>
            </div>
        </>
    )
