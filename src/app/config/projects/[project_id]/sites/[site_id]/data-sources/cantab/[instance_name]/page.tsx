...
export default function ShowCantabDataSource({ params }: { params: Params }) {
                            ...
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="p-4 border-b md:border-b-0 md:border-r flex items-center gap-4 col-span-1 md:col-span-2">
                                        <Image src="/logo/cantab.jpg" alt="CANTAB" width={48} height={48} className="rounded" />
                                        <div>
                                ...
                                <div className="p-4 border-t">
                                    <div className="mb-2 font-semibold">CANTAB Configuration</div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div><span className="font-medium">Keystore Name:</span> <span className="font-mono">••••••••••</span></div>
                                        <div><span className="font-medium">API Endpoint:</span> <span className="font-mono">{dataSource.data_source_metadata?.api_endpoint}</span></div>
                                    </div>
                                </div>
                                <div className="flex gap-2 p-4 border-t">
                                    <Button variant="outline" asChild size="sm"><Link href={`/config/projects/${projectId}/sites/${siteId}/data-sources/cantab/${instanceName}/edit`}><Pencil className="w-4 h-4 mr-1" />Edit</Link></Button>
