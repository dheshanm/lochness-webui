...
export default function ShowSharepointDataSource({ params }: { params: Params }) {
                            ...
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="p-4 border-b md:border-b-0 md:border-r flex items-center gap-4 col-span-1 md:col-span-2">
                                        <Image src="/logo/sharepoint.png" alt="SharePoint" width={48} height={48} className="rounded" />
                                        <div>
                                ...
                                <div className="p-4 border-t">
                                    <div className="mb-2 font-semibold">SharePoint Configuration</div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div><span className="font-medium">Keystore Name:</span> <span className="font-mono">••••••••••</span></div>
                                        <div><span className="font-medium">Site URL:</span> <span className="font-mono">{dataSource.data_source_metadata?.site_url}</span></div>
                                        <div><span className="font-medium">Form ID:</span> <span className="font-mono">{dataSource.data_source_metadata?.form_id}</span></div>
                                    </div>
                                </div>
                                <div className="flex gap-2 p-4 border-t">
                                    <Button variant="outline" asChild size="sm"><Link href={`/config/projects/${projectId}/sites/${siteId}/data-sources/sharepoint/${instanceName}/edit`}><Pencil className="w-4 h-4 mr-1" />Edit</Link></Button>
